...
const allPassports = [
  ...
  { name: 'Australia', slug: 'australia-passport', visaFreeCount: 189, flag: '🇦🇺' },
  { name: 'Austria', slug: 'austria-passport', visaFreeCount: 191, flag: '🇦🇹' },
  { name: 'Belgium', slug: 'belgium-passport', visaFreeCount: 190, flag: '🇧🇪' },
  { name: 'Brazil', slug: 'brazil-passport', visaFreeCount: 171, flag: '🇧🇷' },
  { name: 'Canada', slug: 'canada-passport', visaFreeCount: 188, flag: '🇨🇦' },
  ...
  { name: 'Czech Republic', slug: 'czech-passport', visaFreeCount: 187, flag: '🇨🇿' },
  { name: 'Denmark', slug: 'denmark-passport', visaFreeCount: 191, flag: '🇩🇰' },
  { name: 'Egypt', slug: 'egypt-passport', visaFreeCount: 50, flag: '🇪🇬' },
  { name: 'Finland', slug: 'finland-passport', visaFreeCount: 192, flag: '🇫🇮' },
  { name: 'France', slug: 'france-passport', visaFreeCount: 192, flag: '🇫🇷' },
  { name: 'Germany', slug: 'germany-passport', visaFreeCount: 192, flag: '🇩🇪' },
  { name: 'Greece', slug: 'greece-passport', visaFreeCount: 189, flag: '🇬🇷' },
  { name: 'Hungary', slug: 'hungary-passport', visaFreeCount: 187, flag: '🇭🇺' },
  { name: 'India', slug: 'indian-passport', visaFreeCount: 57, flag: '🇮🇳' },
  ...
  { name: 'Italy', slug: 'italy-passport', visaFreeCount: 192, flag: '🇮🇹' },
  { name: 'Japan', slug: 'japan-passport', visaFreeCount: 193, flag: '🇯🇵' },
  { name: 'Mexico', slug: 'mexico-passport', visaFreeCount: 159, flag: '🇲🇽' },
  { name: 'Morocco', slug: 'morocco-passport', visaFreeCount: 72, flag: '🇲🇦' },
  { name: 'Netherlands', slug: 'netherlands-passport', visaFreeCount: 191, flag: '🇳🇱' },
  { name: 'New Zealand', slug: 'new-zealand-passport', visaFreeCount: 190, flag: '🇳🇿' },
  { name: 'Nigeria', slug: 'nigeria-passport', visaFreeCount: 43, flag: '🇳🇬' },
  { name: 'Norway', slug: 'norway-passport', visaFreeCount: 191, flag: '🇳🇴' },
  { name: 'Pakistan', slug: 'pakistan-passport', visaFreeCount: 31, flag: '🇵🇰' },
  { name: 'Peru', slug: 'peru-passport', visaFreeCount: 138, flag: '🇵🇪' },
  { name: 'Philippines', slug: 'philippines-passport', visaFreeCount: 67, flag: '🇵🇭' },
  { name: 'Poland', slug: 'poland-passport', visaFreeCount: 188, flag: '🇵🇱' },
  { name: 'Portugal', slug: 'portugal-passport', visaFreeCount: 190, flag: '🇵🇹' },
  ...
  { name: 'Spain', slug: 'spain-passport', visaFreeCount: 192, flag: '🇪🇸' },
  { name: 'Sweden', slug: 'sweden-passport', visaFreeCount: 191, flag: '🇸🇪' },
  { name: 'Switzerland', slug: 'switzerland-passport', visaFreeCount: 190, flag: '🇨🇭' },
  ...
  { name: 'United Arab Emirates', slug: 'uae-passport', visaFreeCount: 185, flag: '🇦🇪' },
  { name: 'United Kingdom', slug: 'uk-passport', visaFreeCount: 190, flag: '🇬🇧' },
