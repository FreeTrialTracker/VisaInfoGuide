...
import { CircleCheck as CheckCircle, ArrowRight, Search, FileText } from 'lucide-react';
...
export const metadata: Metadata = {
  title: 'Visa Requirements by Passport and Destination (2026)',
  ...
  openGraph: {
    title: 'Check Visa Requirements by Passport and Destination',
    description: 'Check if you need a visa based on your passport and destination. Get instant visa requirement answers for 2026 including visa-free, visa on arrival, eVisa, and visa required outcomes.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Check Visa Requirements by Passport (2026) | VisaInfoGuide',
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <header className="mt-8 mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Check Visa Requirements by Passport and Destination (2026)
            </h1>
          ...
          <AirportLayoverNotice variant="airport layover hotels" />
