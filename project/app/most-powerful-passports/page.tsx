...
export const metadata: Metadata = {
  title: 'Most Powerful Passports in the World 2026 | VisaInfoGuide',
  description: 'Which passport gives you the most visa-free access in 2026? Full passport power ranking by visa-free destination count, tier breakdowns, and country-by-country entry requirement comparisons.',
  alternates: { canonical: canonicalUrl('/most-powerful-passports') },
  openGraph: {
    title: 'Most Powerful Passports in the World 2026 | VisaInfoGuide',
    description: 'Full passport power ranking by visa-free destination count, tier breakdowns, and country-by-country entry requirement comparisons for 2026.',
    type: 'article',
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <aside className="mb-10 bg-blue-50 border border-blue-200 rounded-xl p-6 flex items-start gap-4">
            ...
            <div>
              <p className="text-sm font-semibold text-blue-900 mb-1">Want to Settle in a High-Ranking Country?</p>
              <p className="text-sm text-blue-800 leading-relaxed mb-3">
                Passport strength often reflects reciprocal access. If you are considering{' '}
                <a href="https://www.immigrationinfoguide.com" target="_blank" rel="noopener noreferrer" className="font-medium underline underline-offset-2 hover:text-blue-600 transition-colors">
                  settling abroad, obtaining residency, or applying for citizenship
                </a>
                {' '}in one of the world's top-ranked passport countries, ImmigrationInfoGuide covers immigration pathways, work visas, and permanent residence requirements.
              </p>
