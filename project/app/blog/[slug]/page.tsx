...
const BLOG_RESOURCES: Record<string, { label: string; href: string }[]> = {
  ...
  'etias-application-guide-us-travelers': [
    { label: 'Do you need a visa to go to Italy?', href: '/blog/do-you-need-a-visa-to-go-to-italy' },
    { label: 'Moving to Italy: tips for Americans', href: '/blog/moving-to-italy-tips-for-americans' },
    { label: 'What to pack for a Europe trip', href: '/blog/what-to-pack-for-europe-trip' },
    { label: 'Schengen 90/180-day calculator', href: '/tools/schengen-calculator' },
    { label: 'US passport → Italy visa requirements', href: '/passport/united-states/destination/italy' },
    { label: 'US passport → France visa requirements', href: '/passport/united-states/destination/france' },
    { label: 'US passport → Germany visa requirements', href: '/passport/united-states/destination/germany' },
    { label: 'Schengen 90/180 rule explained', href: '/research/schengen-90-180-rule-explained' },
  ],
  'do-you-need-a-visa-to-go-to-italy': [
    { label: 'ETIAS application guide for US travelers', href: '/blog/etias-application-guide-us-travelers' },
    { label: 'Moving to Italy: tips for Americans', href: '/blog/moving-to-italy-tips-for-americans' },
    { label: 'What to pack for a Europe trip', href: '/blog/what-to-pack-for-europe-trip' },
    { label: 'US passport → Italy visa requirements', href: '/passport/united-states/destination/italy' },
    { label: 'Italy entry requirements 2026', href: '/visa-guides/country-entry-requirements/italy-2026' },
    { label: 'Schengen 90/180-day calculator', href: '/tools/schengen-calculator' },
    { label: 'Passport validity rules by country', href: '/research/passport-validity-rules-by-country' },
    { label: 'Schengen 90/180 rule explained', href: '/research/schengen-90-180-rule-explained' },
  ],
  'moving-to-italy-tips-for-americans': [
    ...
    { label: 'Italy entry requirements 2026', href: '/visa-guides/country-entry-requirements/italy-2026' },
    { label: 'Passport validity rules by country', href: '/research/passport-validity-rules-by-country' },
    { label: 'Countries with digital nomad visa', href: '/countries-with-digital-nomad-visa' },
  ],
  'what-to-pack-for-europe-trip': [
    ...
    { label: 'US passport → Italy visa requirements', href: '/passport/united-states/destination/italy' },
    { label: 'Passport validity rules by country', href: '/research/passport-validity-rules-by-country' },
    { label: 'Transit visa checker', href: '/tools/transit-visa-checker' },
  ],
};
