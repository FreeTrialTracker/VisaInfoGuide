...
import { ExternalLink, CircleCheck as CheckCircle, Circle as XCircle, CircleAlert as AlertCircle } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {tripResults.map(result => {
              ...
              const seoLink = `/passport/${passport}/destination/${destination.slug}`;
