...
import { Newspaper, Search, Calendar, ExternalLink, ChevronLeft, ChevronRight, Globe, Hash, TriangleAlert as AlertTriangle, GraduationCap, Briefcase, TrendingDown, CircleAlert as AlertCircle, User } from 'lucide-react';
  ...
  return (
    <section className={isStandalone ? '' : 'mt-16'}>
      ...
      <div className="mt-5 mb-6 flex gap-2">
        ...
        <Button onClick={handleSearch} className="bg-gray-600 hover:bg-gray-700 text-white px-5">
          Search
        </Button>
      </div>
