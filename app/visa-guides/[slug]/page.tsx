...
const articles: Record<string, VisaGuideArticle> = {
  ...
  'do-chinese-citizens-need-visa-for-france-2026': {
    ...
    title: 'Do Chinese Citizens Need a Visa for France in 2026?',
  ...
  'do-indians-need-visa-for-japan-2026': {
    ...
    title: 'Do Indians Need a Visa for Japan in 2026?',
  ...
  'do-thais-need-visa-for-japan-2026': {
    ...
    title: 'Do Thais Need a Visa for Japan in 2026?',
  ...
  'do-us-citizens-need-visa-for-europe-2026': {
    ...
    title: 'Do US Citizens Need a Visa for Europe in 2026?',
  ...
  'do-indians-need-visa-for-dubai-2026': {
    ...
    title: 'Do Indians Need a Visa for Dubai in 2026?',
  ...
  'do-uk-citizens-need-visa-for-australia-2026': {
    ...
    title: 'Do UK Citizens Need a Visa for Australia in 2026?',
  ...
  'do-canadians-need-visa-for-thailand-2026': {
    ...
    title: 'Do Canadians Need a Visa for Thailand in 2026?',
  ...
  'do-chinese-citizens-need-visa-for-singapore-2026': {
    ...
    title: 'Do Chinese Citizens Need a Visa for Singapore in 2026?',
  ...
  'do-australians-need-visa-for-japan-2026': {
    ...
    title: 'Do Australians Need a Visa for Japan in 2026?',
  ...
  'do-filipinos-need-visa-for-south-korea-2026': {
    ...
    title: 'Do Filipinos Need a Visa for South Korea in 2026?',
  ...
  'do-brazilians-need-visa-for-usa-2026': {
    ...
    title: 'Do Brazilians Need a Visa for the USA in 2026?',
  ...
  'do-south-africans-need-visa-for-uk-2026': {
    ...
    title: 'Do South Africans Need a Visa for the UK in 2026?',
  ...
  'do-mexicans-need-visa-for-canada-2026': {
    ...
    title: 'Do Mexicans Need a Visa for Canada in 2026?',
  ...
  'do-vietnamese-need-visa-for-thailand-2026': {
    ...
    title: 'Do Vietnamese Need a Visa for Thailand in 2026?',
    ...
    <>
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="bg-white"><td className="px-6 py-4 text-sm font-medium text-gray-900">Visa Required</td><td className="px-6 py-4 text-sm text-gray-700">No (for tourism up to 90 days per 180-day period)</td></tr>
              <tr className="bg-gray-50"><td className="px-6 py-4 text-sm font-medium text-gray-900">Visa-Free Stay</td><td className="px-6 py-4 text-sm text-gray-700">90 days within any 180-day period (Schengen Area)</td></tr>
              <tr className="bg-white"><td className="px-6 py-4 text-sm font-medium text-gray-900">ETIAS Required</td><td className="px-6 py-4 text-sm text-gray-700">Not yet in force (check official ETIAS site for launch date)</td></tr>
              <tr className="bg-gray-50"><td className="px-6 py-4 text-sm font-medium text-gray-900">Passport Validity</td><td className="px-6 py-4 text-sm text-gray-700">Valid for duration of stay (3 months beyond departure recommended)</td></tr>
              <tr className="bg-white"><td className="px-6 py-4 text-sm font-medium text-gray-900">Proof of Onward Travel</td><td className="px-6 py-4 text-sm text-gray-700">May be requested</td></tr>
              <tr className="bg-gray-50"><td className="px-6 py-4 text-sm font-medium text-gray-900">Proof of Funds</td><td className="px-6 py-4 text-sm text-gray-700">May be requested</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      <section id="schengen-area" className="mb-10 scroll-mt-24">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">What Is the Schengen Area?</h2>
        <p className="text-gray-700 leading-relaxed mb-4">The Schengen Area is a group of <strong>27 European countries</strong> that have abolished passport controls at their shared borders, creating a single travel zone. US citizens can travel freely between all Schengen member states on a single entry. Countries include France, Germany, Italy, Spain, Portugal, Netherlands, Austria, Switzerland, Greece, and others.</p>
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-4">
          <p className="text-sm text-blue-900"><strong>Note:</strong> The United Kingdom, Ireland, Romania, Bulgaria, and Cyprus are EU members but are not part of the Schengen Area. Separate entry rules apply to those countries.</p>
        </div>
      </section>
      <section id="90-180-rule" className="mb-10 scroll-mt-24">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">The 90/180-Day Rule Explained</h2>
        <p className="text-gray-700 leading-relaxed mb-4">US citizens can stay in the Schengen Area for <strong>up to 90 days within any rolling 180-day period</strong>. This is not a calendar year limit — it is calculated from your most recent entry date, rolling back 180 days. Days spent in any Schengen country count toward this 90-day total. Use our <Link href="/tools/schengen-calculator" className="text-teal-600 hover:text-teal-700 font-medium underline">Schengen Calculator</Link> to track remaining days.</p>
      </section>
      <section id="etias" className="mb-10 scroll-mt-24">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">ETIAS: Upcoming Requirement for US Citizens</h2>
        <p className="text-gray-700 leading-relaxed mb-4">ETIAS (European Travel Information and Authorisation System) is a pre-travel authorisation being introduced for visa-exempt nationalities, including US citizens. It is <strong>not yet in force as of early 2026</strong>. Once launched, US travelers will need to apply online and receive ETIAS approval before boarding any flight to a Schengen country.</p>
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
          <p className="text-sm text-amber-900"><strong>Important:</strong> Always check the official ETIAS website for the current launch date before booking travel to Europe.</p>
        </div>
      </section>
      <section id="documents-required" className="mb-10 scroll-mt-24">
        ...
        <ul className="space-y-3 text-gray-700">
          <li className="flex items-start gap-3"><span className="font-semibold min-w-[200px]">Passport:</span><span>Valid US passport. Many Schengen countries recommend at least 3 months validity beyond your planned departure date.</span></li>
          <li className="flex items-start gap-3"><span className="font-semibold min-w-[200px]">Return Ticket:</span><span>Proof of onward or return travel out of the Schengen Area may be requested.</span></li>
          <li className="flex items-start gap-3"><span className="font-semibold min-w-[200px]">Proof of Funds:</span><span>Border officers may ask for evidence of sufficient funds to support your stay.</span></li>
          <li className="flex items-start gap-3"><span className="font-semibold min-w-[200px]">Accommodation:</span><span>Hotel bookings or a host invitation letter may be requested.</span></li>
        </ul>
      </section>
    </>
  );
  ...
  return (
    <>
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="bg-white">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">Visa Required</td>
                <td className="px-6 py-4 text-sm text-gray-700">No (for stays up to 60 days)</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">Maximum Stay</td>
                <td className="px-6 py-4 text-sm text-gray-700">60 days per entry</td>
              </tr>
              <tr className="bg-white">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">Passport Validity</td>
                <td className="px-6 py-4 text-sm text-gray-700">At least 6 months beyond departure date</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">Onward Ticket</td>
                <td className="px-6 py-4 text-sm text-gray-700">Required (departure within 60 days)</td>
              </tr>
              <tr className="bg-white">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">Proof of Funds</td>
                <td className="px-6 py-4 text-sm text-gray-700">May be requested (20,000 baht per person)</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="px-6 py-4 text-sm font-medium text-gray-900">Extension Possible</td>
                <td className="px-6 py-4 text-sm text-gray-700">Yes, one 30-day extension available</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="text-gray-700 leading-relaxed mb-4">
          US citizens can enter Thailand under the <Link href="/visa-guides/travel-visa-rules#visa-free" className="text-teal-600 hover:text-teal-700 font-medium underline">visa-free</Link> exemption scheme for tourism or business purposes only. Business purposes include attending meetings, conferences, or seminars, but do not include any form of employment or work.
        </p>
      </section>

      <section id="stay-duration" className="mb-10 scroll-mt-24">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">How Long Can US Citizens Stay in Thailand?</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          US citizens benefit from Thailand's <Link href="/visa-guides/travel-visa-rules#visa-free" className="text-teal-600 hover:text-teal-700 font-medium underline">visa-free</Link> exemption scheme, which allows stays of up to <strong>60 days per entry</strong>. This policy was updated in 2024, extending the previous 30-day limit to encourage tourism.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
          <li>
            <strong>Extension at Immigration:</strong> Visit a Thai immigration office before your 60 days expire to apply for a one-time 30-day extension. The fee is 1,900 baht, and you'll need to provide a passport photo, copies of your passport and entry stamp, and proof of accommodation.
          </li>
          <li>
            <strong>Border Run:</strong> Exit Thailand and re-enter to receive another 60-day stamp. However, frequent border runs may attract scrutiny from immigration officers who may question your intentions.
          </li>
        </ul>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section id="when-visa-required" className="mb-10 scroll-mt-24">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">When Is a Visa Required?</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          While most US tourists can enter Thailand under the <Link href="/visa-guides/travel-visa-rules#visa-free" className="text-teal-600 hover:text-teal-700 font-medium underline">visa-free</Link> scheme, you will need to apply for an appropriate <Link href="/visa-guides/travel-visa-rules#visa-required" className="text-teal-600 hover:text-teal-700 font-medium underline">visa</Link> in advance if you plan to:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6 ml-4">
          <li><strong>Stay longer than 60 days:</strong> Apply for a Tourist Visa (TR), which allows stays of up to 60 days with the possibility of a 30-day extension</li>
          <li><strong>Work or teach:</strong> Obtain a Non-Immigrant B Visa and work permit before starting employment</li>
          <li><strong>Study:</strong> Apply for a Non-Immigrant ED Visa for education purposes</li>
          <li><strong>Volunteer:</strong> Secure a Non-Immigrant O Visa for volunteering activities</li>
          <li><strong>Retire in Thailand:</strong> Apply for a Non-Immigrant O-A (retirement) Visa if you're over 50</li>
          <li><strong>Conduct business activities beyond meetings:</strong> Obtain a Non-Immigrant B Visa</li>
        </ul>
        <p className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              ...
              <span>Must be valid for at least <Link href="/visa-guides/travel-visa-rules#passport-validity" className="text-teal-600 hover:text-teal-700 font-medium underline">6 months beyond your planned departure date</Link> from Thailand</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-semibold min-w-[140px]">Onward Ticket:</span>
              <span><Link href="/visa-guides/travel-visa-rules#onward-travel" className="text-teal-600 hover:text-teal-700 font-medium underline">Proof of departure</Link> from Thailand within 60 days (airline ticket, bus ticket, etc.)</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-semibold min-w-[140px]">Proof of Funds:</span>
              <span>Ability to show <Link href="/visa-guides/travel-visa-rules#proof-of-funds" className="text-teal-600 hover:text-teal-700 font-medium underline">20,000 baht per person or 40,000 baht per family</Link> (rarely requested but required by law)</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="font-semibold min-w-[140px]">Accommodation:</span>
              <span>Hotel booking or address where you'll be staying (may be requested)</span>
            </li>
          </ul>
        </div>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section id="overstay-penalties" className="mb-10 scroll-mt-24">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Penalty Structure:</h3>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
        ...
        <p className="text-gray-700 leading-relaxed">
          <strong>Important:</strong> Always keep track of your entry stamp date and departure date. Set reminders well before your 60 days expire to either leave Thailand or visit an immigration office for an extension. Overstaying even by one day can cause complications for future travel.
        </p>
      </section>
    </>
  );
