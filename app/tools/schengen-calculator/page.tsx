...
import { TriangleAlert as AlertTriangle, CircleCheck as CheckCircle, Calendar, Info } from 'lucide-react';
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Free online calculator for tracking Schengen Area stays using the rolling 180-day window method',
          }),
        }}
      />
        ...
        <div className="container mx-auto px-4 py-12 max-w-5xl">
          ...
          <section>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <h3 className="font-semibold text-blue-900 mb-3">Related resources</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  ...
                  >
                    Complete guide to the Schengen 90/180 rule
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className="text-blue-700 hover:text-blue-800 hover:underline"
                  >
                    Browse all visa guides and resources
                  </Link>
                </li>
              </ul>
            </div>
